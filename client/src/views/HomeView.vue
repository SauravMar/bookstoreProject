...
.outer-welcome-container {
  width: 100%;
  padding: 2% 0;
  max-height: var(--default-viewing-area-height);
}
  ...
  <div class="home-page">
    ...
    <div class="outer-welcome-container">
      ...
      <div class="cta-container">
        <router-link to="/category/Classics" tag="span">
          <button class="primary-button cta-btn">SHOP NOW</button>
        </router-link>
        &nbsp;
        <button class="primary-button non-cta-btn">
